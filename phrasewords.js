function handleUserDissatisfaction(phrase) {
    ...
    } else if (lowerCasePhrase.includes("misunderstood my question") || lowerCasePhrase.includes("didn't get my question") || lowerCasePhrase.includes("didn't understand")) {
        botResponse = "I apologize if I misunderstood. Could you please clarify your question?";
    } else if (lowerCasePhrase.includes("isn't helpful") || lowerCasePhrase.includes("not helpful") || lowerCasePhrase.includes("not useful")) {
    ...
    } else if (lowerCasePhrase.includes("didn't answer my question") || lowerCasePhrase.includes("didn't answer") || lowerCasePhrase.includes("no answer")) {
...
function thankingStatementsResponse(thanking) {
    let botResponse = "";
    if (thanking.includes('thank you')) {
        botResponse = "You're welcome! How can I assist you further?";
    } else if (thanking.includes('thanks')) {
        botResponse = "No problem! Is there anything else I can help you with?";
    } else if (thanking.includes('thanks a lot')) {
        botResponse = "You're welcome! Feel free to ask if you need anything else.";
    } else if (thanking.includes('thank you very much')) {
        botResponse = "You're very welcome! How can I assist you further?";
    } else if (thanking.includes('thanks so much')) {
        botResponse = "You're welcome! Is there anything else you need help with?";
        ...
        botResponse = "You're welcome! Let me know if there's anything else you need.";
    } 
    return botResponse;
}
...
function othersWords(matchedWordOthers) {
    let botResponse = "";
    if (matchedWordOthers === "shorthand") {
        botResponse = "<b>Shorthand</b> is a system of writing that uses symbols or abbreviations to represent words, phrases, or letters.<br /><br /> It is designed to enable fast and efficient transcription of spoken language or dictation. Shorthand systems vary in complexity and style, but they generally aim to capture the essence of speech in a concise and abbreviated form.<br /><br />Historically, shorthand was particularly popular before the widespread adoption of recording devices and stenography machines. It was commonly used by professionals such as journalists, secretaries, court reporters, and students who needed to take rapid notes during lectures or meetings.Some well-known shorthand systems include:<br /> <br />1.Pitman Shorthand: Developed by Sir Isaac Pitman in the 19th century, Pitman Shorthand is one of the most widely used shorthand systems. It uses a combination of straight lines, curves, and dots to represent sounds, consonants, and vowels.<br /><br /> 2. Gregg Shorthand: Created by John Robert Gregg in the late 19th century, Gregg Shorthand is another popular system. It is based on the principle of cursive handwriting and uses strokes and curves to represent sounds and phonetics.<br /><br /> 3. Teeline Shorthand: Developed in the 1960s by James Hill, Teeline Shorthand is a more simplified system designed for faster learning and easier use. It uses a combination of simplified characters and phonetic symbols.<br /><br /> 4. Speedwriting: This is a system that combines elements of shorthand and longhand writing. It is based on abbreviations and phonetics, allowing for faster writing while still maintaining readability.<br /><br />While shorthand was once an essential skill for certain professions, its usage has declined with the advent of modern technology, such as digital recording devices and speech-to-text software. However, shorthand still has its enthusiasts and is occasionally taught as a valuable skill for those who need to take rapid and accurate notes.";
    } else if (matchedWordOthers === 'typewriter' || matchedWordOthers === 'typewitter' || matchedWordOthers === 'who is typewriter') {
        if (matchedWordOthers === 'typewriter' || matchedWordOthers === 'typewitter') {
            botResponse = "<b>typewriter</b> is a mechanical or electromechanical device with keys that, when pressed, cause characters to be printed on paper.<br /><br /> Before the widespread use of computers and printers, typewriters were commonly used for creating documents, letters, and other written materials.<br /><br /> They were essential tools in offices, businesses, and homes for much of the 20th century.Typewriters come in various models, sizes, and designs, but they generally consist of a keyboard for typing, a mechanism for striking the paper with inked characters, and a carriage that moves the paper along for typing successive lines.<br /><br /> Early typewriters were purely mechanical, while later models incorporated electric motors for powering certain functions.Although typewriters have largely been replaced by computers and printers, they still hold nostalgic value for many people and are occasionally used by writers, collectors, and enthusiasts. Some typewriter models are prized for their craftsmanship and design, and they remain sought-after items among collectors of vintage technology.";
        } else if (matchedWordOthers === 'who is typewriter') {
            botResponse = "I'm sorry, but there isn't any well-known individual or entity named Typewitter that I'm aware of. It's possible that it might be a misspelling or a reference to something specific that I'm not familiar with. If you could provide more context or clarify your question, I'd be happy to try to help further.";
        }
    }
    return botResponse;
}
